...
/// @file
/// @mainpage Light-weight, internationalized, inter-thread log messages.
/// 
...
///
/// Log messages may be simply and easily internationalized with
/// language choice being possible at runtime.
///
...
///
/// See the Developer's Guide for information on how compile and use
/// liblog and for further information on features.
///
/// Contributions are welcome via https://github.com/cobaro/liblog.
/// Please submit proposed changes as a pull request, or attach a
/// patch to a GitHub issue.
///
/// Code level documentation starts with <a href='log_8h.html'>log.h</a>
